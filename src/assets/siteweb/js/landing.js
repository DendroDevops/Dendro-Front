$(function () {
    ...
    // Custom classes that will be applied depending on components scrollTop value
    var navbarCustomClasses = {
        // when user is on the top of the components
        default: {},

        // when components scrollTop value > navbarScrollThreshold
        alt: {}
    };
